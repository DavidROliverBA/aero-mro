...
| **EASA e-records guidelines (2023)** | Electronic records need traceability, integrity, authenticity; e-signature levels | Sign-offs recorded with engineer identity + timestamp (demo-grade "basic" level; AES/QES is a Tier 3 roadmap item) |
